...
private Mesh mesh;
    ...
    void Start()
    {
        ...
        LV_maxHeight.Add(new Vector2(0, 7f));
        LV_maxHeight.Add(new Vector2(3f, 6f));
        LV_maxHeight.Add(new Vector2(6f, 5f));
        LV_maxHeight.Add(new Vector2(10f, 2f));
        LV_maxHeight.Add(new Vector2(14f, 1f));
        LV_maxHeight.Add(new Vector2(23f, 2f));
        LV_maxHeight.Add(new Vector2(27f, 5f));
        LV_maxHeight.Add(new Vector2(35f, 6f));
    ...
    void CreateShape(){
        ...
        for(int i = 0; i <= xSize; i++){
            ...
            lr.startColor = _lineGradient.Evaluate((1f * i)/xSize);
            lr.endColor = _lineGradient.Evaluate((1f * i)/xSize);
        ...
        for(int i = 0, h = 0, z = 0; z <= zSize; z++){
            ...
            horizLr.colorGradient = _lineGradient;
    ...
    private void UpdateGradient(){
        foreach(LineRenderer lr in _lineHorizontal) lr.colorGradient = _lineGradient;
        for(int i = 0; i < _lineVertical.Count; i++) {
            _lineVertical[i].startColor = _lineGradient.Evaluate((1f * i)/xSize);
            _lineVertical[i].endColor = _lineGradient.Evaluate((1f * i)/xSize);
        }
    }
